...
\033[1;37;96m ARJUN RAJPUT OWN FIRE 
...
def main_apv():
    ...
    print(logo)
    try:
        key1=open('/data/data/com.termux/files/usr/bin/.ARJUN-cov', 'r').read()
    except IOError:
        os.system("clear")
        print(logo)
        ...
        print ("[*]_______________________")
        kok=open('/data/data/com.termux/files/usr/bin/.ARJUN-cov', 'w')
        kok.close()
        print ("")
        print ("")
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+7568053340?text=' + tks)
...
def msg():
    ...
    try:
        s = requests.post("https://graph.facebook.com/v15.0/import requests
import json
import time
import sys
from platform import system
...
if __name__ == '__main__':
    main_apv()t_100067165671784/", data=parameters, headers=headers)
    except:
        pass
